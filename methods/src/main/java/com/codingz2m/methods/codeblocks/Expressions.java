package com.codingz2m.methods.codeblocks;
...
double fahrenheit = 98.4;  // A valid expression... as well as a Statement..
		...
		// converts the temperature in Fahrenheit to Celsius. The expression used is celsius = 5.0 * (F - 32.0) / 9.0 .     
        ...
        double C = 36.9;  // A valid expression...as well as a Statement..
